...
RSpec.describe CoursePlan do
  ...
  describe "enums" do
    it { is_expected.to define_enum_for(:status).with_values(planned: "planned", enrolled: "enrolled", completed: "completed", dropped: "dropped", cancelled: "cancelled").with_default(:planned) }
  end
