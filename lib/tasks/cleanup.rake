...
namespace :cleanup do
  ...
  task duplicate_tbd_events_dry_run: :environment do
    ...
    users.find_each do |user|
      ...
      grouped_events.each_value do |events|
        ...
        events.each do |event|
          ...
          is_tbd ? tbd_events << event : valid_events << event
        end
    ...
    puts "Run 'rails cleanup:duplicate_tbd_events' to delete these duplicates" if total_duplicates > 0
  end
end
