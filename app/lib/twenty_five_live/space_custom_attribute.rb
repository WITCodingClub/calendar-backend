...
module TwentyFiveLive
  class SpaceCustomAttribute
    SPACE_CUSTOM_ATTRIBUTES = [
      ...
      { attribute_id: -3,  attribute_name: "Map",                    defn_state: 0 },
      { attribute_id: -6,  attribute_name: "X25 Building",           defn_state: 1 },
      { attribute_id: -7,  attribute_name: "X25 Owner Organization", defn_state: 0 },
      { attribute_id: -9,  attribute_name: "X25 Room Use Code",      defn_state: 1 },
      { attribute_id: -10, attribute_name: "X25 Floor Number",       defn_state: 0 },
      ...
      { attribute_id: -81, attribute_name: "WDYT Location Survey",   defn_state: 0 }
    ].freeze
  end
end
